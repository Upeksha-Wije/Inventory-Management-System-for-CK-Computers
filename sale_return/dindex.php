...
<head>
    <meta charset="UTF-8">
    <title>Deleted Sales Return Management</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 mx-auto">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Deleted Sales Return Management</h2>
                    </div>
                   
                    <a href="index.php" class="btn btn-primary pull-right">&nbsp;<i class="fa fa-arrow-circle-left"></i> Sales Return Management</a>
                    ...
                    $sql = "SELECT * FROM sale_returns WHERE dlt=1 ORDER BY `id` DESC";
                            ...
                            echo "<div class='bg-white p-3'><table class='table table-bordered table-striped table-hover table-responsive-sm' id='myTable'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        $sql2 = "SELECT * FROM sale_returns WHERE id=$sale_returns";
                                        $result2 = mysqli_query($link, $sql2);
                                        $row2 = mysqli_fetch_array($result2);
                                        $invoice = $row2['invoice'];

                                        $sql3 = "SELECT * FROM purchases WHERE id=$invoice";
                                        ...
                                        echo "<td class='text-right'>";   
                                            if($status==1){
                                                ...
                                                echo "<a href='dview.php?id=". $row['id'] ."' title='View Sales Return' data-toggle='tooltip'>&nbsp;<i class='fa fa-eye'></i>&nbsp;</a>";    
