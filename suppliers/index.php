...
<?php 
    if(isset($_POST['delete'])){
        ...
        $sql = "UPDATE suppliers SET status = 0 WHERE id= '$delete_id'";
            ...
            <div class="col-lg-3"></div>
                ...
                <div class="col-md-8">
                    <div class="mt-5 mb-3 clearfix">
                        <h2 class="pull-left">Suppliers Management</h2>
                        <a href="create.php" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New supplier</a>
                    </div>
                    <?php
