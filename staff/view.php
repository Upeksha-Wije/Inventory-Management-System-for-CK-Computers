        ...
        <div class="row">       
            <div class="mx-auto col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="form group col-sm-6">                         
                        <div class="form-control-static"><?php echo $row["gender"]; ?></div>
                    </div>   
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form group col-sm-6">  
                        <div class="form-control-static"><?php echo $row["dob"]; ?></div>
                    </div>  
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form group col-sm-6">  
                        <div class="form-control-static"><?php echo $row["user_type"]; ?></div>
                    </div>
                </div>
                ...
                <div class="row">  
                    ...
                    <div class="form group col-sm-6">  
                        <div class="form-control-static"><?php echo $row["username"]; ?></div>
                    </div>
                </div>
