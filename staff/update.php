...
$title = $name = $name2 = $gender = $address =$email = $mobile =$dob = $nic = $user_type = $username = $password_old = $password_1 = $password_2 = $status = "";
$name_err = $name2_err = $gender_err = $address_err = $email_err = $mobile_err = $dob_err = $nic_err = $user_type_err = $password_old_err = $password_1_err = $password_err = "";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $hpassword_old = md5($password_old);
    if ($hpassword_old != $password_1) {
        $password_old_err = "Please provide the correct current password";
    }*/
    ...
    if(empty($name_err) && empty($name2_err) && empty($gender_err) && empty($address_err) && empty($mobile_err) && empty($nic_err) && empty($password_old_err) && empty($password_err)){
        // Get the id of the record
        $id =  $_GET["id"];
        // Prepare an update statementto pdate the record
        $sql = "UPDATE `staff` SET `title`=?,`firstname`=?,`lastname`=?,`gender`=?,`address`=?,`email`=?,`mobile`=?,`dob`=?,`nic`=?,`user_type`=?,`username`=?,`password`=?,`status`=? WHERE id=$id;";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            $param_password = md5($password_2); //encrypt the password before saving in DB
            $param_status = $status;
        ...
        <div class="container col-lg-6">
            <div class="row">
                <div class="mx-auto">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6">
                            <label class="font-weight-bold">Gender :<code>*</code> &nbsp;</label>
                        </div>
                        <div class="form-group col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            <input type="password" name="password_old" class="form-control" value="<?php echo $password_old; ?>">
                            <code><span class="help-block"><?php echo $password_old_err;?></span></code>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <code><span class="help-block"><?php echo $password_err; ?></span></code>
                        </div>        
                    </div>
