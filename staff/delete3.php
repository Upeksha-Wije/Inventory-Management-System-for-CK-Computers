...
// Prepare a delete statement fro purchases_details table
    $sql = "UPDATE staff SET status=0 WHERE dlt=0 && staff_id = ?";
    ...
    $sql6 = "UPDATE staff SET status=0, dlt=1 WHERE id = ?";
                ...
                <div class="mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">        
                        <div class="alert alert-danger">
                            ...
                            <div>Are you sure you want to delete this Staff Record?</div><br>
                            <div>
