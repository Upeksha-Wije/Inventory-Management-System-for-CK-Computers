                            ...
                            echo '<div class="bg-white p-3"><table class="table table-bordered table-striped" id="myTable" >';
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";   
                                        $z=$row['p_cat_id']; 
                                        $count="SELECT category_name FROM category WHERE id=$z"; // SQL to get records 
                                    ...
                                    echo "</td>";
                                        ...
                                        echo "<td>";
                                            ...
                                            echo '<a href="#" class= "icon" title="Delete Record" data-toggle="modal" data-target="#myModal'.$row['id'] .'"><span class="fa fa-trash"></span> </a>';
