...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "UPDATE purchase_return_details SET status=1 WHERE dlt=0 && purchase_return_id = ?";
    ...
    if($result2 = mysqli_query($link, $sql2)){
        while($row2 = mysqli_fetch_array($result2)){
            ...
            $sql4 = "SELECT * FROM purchase_return_details WHERE purchase_return_id=$param_id && dlt=0 && product=$product";
    ...
    $sql6 = "UPDATE purchase_return SET status=1, dlt=0 WHERE id = ?";
...
<head>
    <meta charset="UTF-8">
    <title>Recover Purchase Return</title>
                ...
                <div class="mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">        
                        <div class="alert alert-danger">
                            ...
                            <div>Are you sure you want to recover this Purchase Return?</div><br>
                            <div>
