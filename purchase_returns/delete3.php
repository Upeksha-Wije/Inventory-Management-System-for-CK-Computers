...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql2 = "SELECT * FROM purchase_return_details WHERE purchase_return_id=$param_id && status=1 && dlt=0";
    ...
    // Prepare a delete statement purchase_return table
    $sql6 = "UPDATE purchase_return SET status=0, dlt=1 WHERE id = ?";
...
<head>
    <meta charset="UTF-8">
    <title>Delete Purchase Return</title>
...
<body style="background-image: url(../images/Background/Copy-conL4.jpg); background-size: cover; background-repeat:no-repeat;">
    ...
    <br/>
        ...
        <div class="container col-sm-4 mx-auto">
            <div class="row">
                <div class="mx-auto">
                    <h1>Delete Purchase Return ?</h1>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">        
                        <div class="alert alert-danger">
                            <input type="hidden" name="id" value="<?php echo trim($_GET["id"]); ?>"/>
                            <div>Are you sure you want to delete this Purchase Return?</div><br>
                            <div>
