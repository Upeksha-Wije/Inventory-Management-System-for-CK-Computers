...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($quantity_err)){
        ...
        //INSERTO TO purchase_return DETAILS TABLE               
        $sql = "INSERT INTO purchase_return_details (purchase_return_id, product, quantity, status) VALUES (?, ?, ?, ?)";

        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "isii", $param_purchase_return_id, $param_product, $param_quantity, $param_status);
            
            // Set parameters
            $param_purchase_return_id = trim($_GET["id"]);
            $param_product = (int)$_GET["pid"];
        ...
        <div class="container">
            <div class="row">
                <div class="mx-auto">
                    ...
                    <p>Please fill this form and submit to add items to the Purchase Return.
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["REQUEST_URI"]); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="quantity" class="form-control" value="<?php echo $quantity; ?>" placeholder="Enter the returned item quantity">
