...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "UPDATE purchases SET status=1 WHERE id = ?";
...
<head>
    <meta charset="UTF-8">
    <title>Change Status of Purchase Order</title>
                ...
                <div class="mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">        
                        <div class="alert alert-danger">
                            ...
                            <div>Are you sure you want to change status of this Purchase Order?</div><br>
                            <div>
