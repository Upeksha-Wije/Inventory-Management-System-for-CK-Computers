...
// Prepare a delete statement fro purchases_details table
    $sql = "UPDATE purchases_details SET status=0 WHERE dlt=0 && purchases_id = ?";
    ...
    // Prepare a delete statement purchases table
    $sql6 = "UPDATE purchases SET status=0, dlt=1 WHERE id = ?";
                ...
                <div class="mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">        
                        <div class="alert alert-danger">
                            ...
                            <div>Are you sure you want to delete this Purchase Order?</div><br>
                            <div>
