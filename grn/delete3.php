...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    // Attempt select query execution. Select grn items which are not deleted
    $sql2 = "SELECT * FROM grn_details WHERE grn_id=$param_id && status=1 && dlt=0";
    if($result2 = mysqli_query($link, $sql2)){
        while($row2 = mysqli_fetch_array($result2)){
            ...
            $sql5 = "SELECT * FROM grn_details WHERE grn_id=$param_id && dlt=0 && product=$product";
    ...
    // Prepare a delete statement fro grn_details table
    $sql = "UPDATE grn_details SET status=0 WHERE dlt=0 && grn_id = ?";
    ...
    // Prepare a delete statement grn table
    $sql6 = "UPDATE grn SET status=0, dlt=1 WHERE id = ?";
                ...
                <div class="mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">        
                        <div class="alert alert-danger">
                            ...
                            <div>Are you sure you want to delete this GRN?</div><br>
                            <div>
