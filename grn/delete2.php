...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "UPDATE grn_details SET status=1 WHERE dlt=0 && grn_id = ?";
    ...
    if($result2 = mysqli_query($link, $sql2)){
        while($row2 = mysqli_fetch_array($result2)){
            ...
            $sql4 = "SELECT * FROM grn_details WHERE grn_id=$param_id && dlt=0 && product=$product";
    ...
    $sql6 = "UPDATE grn SET status=1 WHERE id = ?";
