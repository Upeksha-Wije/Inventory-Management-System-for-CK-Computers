...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql2 = "SELECT * FROM grn_details WHERE grn_id=$param_id && dlt=0";
    ...
    // Prepare a delete statement for grn table
    $sql6 = "UPDATE grn SET status=0 WHERE id = ?";
...
<head>
    <meta charset="UTF-8">
    <title>Change Status of GRN</title>
                ...
                <div class="mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">        
                        <div class="alert alert-danger">
                            ...
                            <div>Are you sure you want to change status of this GRN?</div><br>
                            <div>
