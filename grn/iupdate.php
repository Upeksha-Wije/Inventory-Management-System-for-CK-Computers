...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($quantity_err)){
        ...
        //UPDATE GRN DETAILS TABLE          
        $sql2 = "UPDATE `grn_details` SET `product`=?,`quantity`=? WHERE id=?;";       
        ...
        <div class="container">
            <div class="row">
                <div class="mx-auto">
                    ...
                    <p>Please fill this form and submit to update the item in the GRN.
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["REQUEST_URI"]); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="quantity" class="form-control" value="<?php echo $quantity; ?>" placeholder="Enter received product quantity">
