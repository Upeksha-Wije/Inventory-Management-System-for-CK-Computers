            ...
            <div class="col-lg-2"></div>
                <div class="col-sm-10 mx-auto">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Purchase Orders Report</h2>
                    </div>
        ...
        if(isset($_POST['se'])&&$stmt!=""){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_num_rows($result) > 0){
                    ...
                    echo '<a href="purchase_all_print_all.php?from='.$from.'&to='.$to.'&status='.$status.'" class="btn btn-primary pull-left" target="_blank" style="margin-bottom: 10px;"><i class="fa fa-print"></i>&nbsp; Print Result</a>';
