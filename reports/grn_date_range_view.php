            ...
            <div class="row">
                <div class="col-lg-2"></div>    
                    <div class="mx-auto col-lg-10">
                        ...
                        <div>
                            <a href="grn_date_range.php" class="btn btn-primary">Back</a>
                            <?php
                            if($status==1){
                                echo "<a href='grn_date_range_print.php?id=$_GET[id]' title='Print Record' data-toggle='tooltip' target='_blank'><i class='fa fa-print'></i>&nbsp;</a>";
                            }
                            ?>
                        </div>
                    </div> 
