...
function Header()
{
    ...
    $this->cell(0,15,'GRNs by Date Range Report',0,1,'L');
}
...
$pdf->cell(100,15,'Number of GRNs :',0,0,'R');
$pdf->SetFont('Arial','',14);
$pdf->cell(20,15,$number,0,1,'R');

$width_cell=array(20,55,55,50,70,27);//277mm
$pdf->SetFont('Arial','B',14);

$pdf->SetFillColor(193,229,252); // Background color of header 
// Header starts /// 
$pdf->Cell($width_cell[0],10,'GRN ID',1,0,"R",true); // First header column 
