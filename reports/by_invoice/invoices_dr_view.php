            ...
            <div class="col-lg-2"></div>
                <div class="col-lg-10">
                    <div class="page-header">
                        <div class="mb-3"><h1>View Invoice</h1></div>
                    </div>
                    ...
                    $sql = "SELECT * FROM invoices_details WHERE invoices_id=$param_id && status=1 ORDER BY `id` DESC";
                    ...
                    <p><a href="invoices_by_date_range.php" class="btn btn-primary">Back</a>
                    <a href="invoices_dr_print_one.php?id=<?php echo $_GET["id"]; ?>" title="Print Record" data-toggle="tooltip" target="_blank"><i class="fa fa-print"></i>&nbsp;</a></div>   
                    </p>
                </div>
        </div>                  
    </div>
