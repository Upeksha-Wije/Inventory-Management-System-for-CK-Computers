...
function Header()
{
    ...
    $this->cell(0,15,'Invoices by Date Range',0,1,'L');
}
...
$pdf->cell(100,15,'Number of Invoices :',0,0,'R');
$pdf->SetFont('Arial','',14);
...
// Header starts /// 
$pdf->Cell($width_cell[0],10,'Invoice ID',1,0,"R",true); // First header column 
...
$pdf->Cell($width_cell[3],10,'Customer ID',1,0,"R",true); // Second header column
$pdf->Cell($width_cell[4],10,'Customer Name',1,0,"C",true); // Fourth header column
...
if(mysqli_stmt_execute($stmt)){
    ...
    /*
        ...
        */
        ...
        $pdf->Cell($width_cell[3],10,$customer,1,0,"R",$fill);
        $pdf->Cell($width_cell[4],10,$customer_name,1,0,"C",$fill);
