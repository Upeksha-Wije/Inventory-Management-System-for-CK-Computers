            ...
            <div class="col-lg-2"></div>
                <div class="col-lg-10">
                    <div class="page-header">
                        <div class="mb-3"><h1>View Purchase Order</h1></div>
                    </div>
                    ...
                    <p><a href="purchase_date_range.php" class="btn btn-primary">Back</a>
                    <a href="purchase_date_range_print.php?id=<?php echo $_GET["id"]; ?>" title="Print Record" data-toggle="tooltip" target="_blank"><i class="fa fa-print"></i>&nbsp;</a></div>   
                    </p>
                </div>
        </div>                  
    </div>
