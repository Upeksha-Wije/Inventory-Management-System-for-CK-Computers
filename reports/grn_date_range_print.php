    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            if(mysqli_num_rows($result) == 1){
                ...
                $sql2 = "SELECT * FROM grn_details WHERE grn_id=$id && status=1 ORDER BY `id` DESC";
                ...
                $width_cell=array(20,20,80,25,20,20);//190 mm total
                ...
                $pdf->Cell($width_cell[4],10,'Unit Price',1,0,"R",true); // Fourth header column
