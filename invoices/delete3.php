...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql2 = "SELECT * FROM invoices_details WHERE invoices_id=$param_id && status=1 && dlt=0";
    ...
    // Prepare a delete statement invoices table
    $sql6 = "UPDATE invoices SET status=0, dlt=1 WHERE id = ?";
                ...
                <div class="mx-auto">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">        
                        <div class="alert alert-danger">
                            ...
                            <div>Are you sure you want to delete this Invoice ?</div><br>
                            <div>
