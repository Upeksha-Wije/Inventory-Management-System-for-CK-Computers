...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($firstname_err) && empty($lastname_err)  && empty($address_err)&& empty($email_err) && empty($mobile_err) && empty($nic_err) && empty($description_err) ){
        // Prepare an insert statement
        $sql = "INSERT INTO customers (title, firstname, lastname, address,email, mobile,nic,description,status) VALUES (?, ?, ?, ?, ?, ?, ?, ?,?)";
    ...
    <?php if($insert == 1){ ?>
        ...
        <div class="row">
            <div class="col-lg-3"></div>
                ...
                <div class="alert alert-warning alert-dismissible fade show col-lg-8 ml-5 mt-3" role="alert">
        ...
        <div class="container mt-3">
            ...
            <div class="col-lg-6">
                <div class="mx-auto">
                    ...
                    <div class="row">                                                                         
                        <div class="form-group col-sm-6">
                            <label class="font-weight-bold">Description<code>*</code>
                        </div>
                        <div class="form-group col-sm-6">
                            <textarea name="description" class="form-control" placeholder="Enter Discription"><?php echo $description; ?></textarea>
